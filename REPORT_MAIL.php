...
$message='<html><body>'.'<br>'.'<h> '.$sub.'</h>'.'<br>'.'<br>'.'<table border=1  width=1400 ><thead  bgcolor=#6495ed style=color:white><tr  align="center"  height=2px ><td width=260><b>LOGIN ID</b></td><td><b>REPORT</b></td><td width=260><b>USERSTAMP</b></td><td  width=150 nowrap><b>TIMESTAMP</b></td></tr></thead>';
...
//            }
        ...
        $message=$message. "<tr><td width=260>".$adm_loginid."</td><td >".$final_report."</td><td width=260>".$adm_userstamp."</td><td width=150 nowrap>".$adm_timestamp."</td></tr>";
    }

...
//DONE BY:SAFI
//VER 0.08,SD:06/01/2015 ED:06/01/2015,TRACKER NO:74,DESC:ADDED GEOLOCATION AND LOGINID CHANGED AS EMPLOYEE NAME
//DONE BY:RAJA
//VER 0.07,SD:29/12/2014 ED:29/12/2014,TRACKER NO:74,DESC:joined the employee check in/out table with report
//DONE BY:LALITHA
//VER 0.06,SD:05/12/2014 ED:05/12/2014,TRACKER NO:74,DESC:Showned AM nd PM fr Onduty/Absent in Reason
...
$message='<html><body>'.'<br>'.'<h> '.$sub.'</h>'.'<br>'.'<br>'.'<table border=1  width=1700 ><thead  bgcolor=#6495ed style=color:white><tr  align="center"  height=2px ><td width=260><b>EMPLOYEE NAME</b></td><td width=1000><b>REPORT</b></td><td width=50 nowrap><b>CLOCK IN TIME</b></td><td width=560 nowrap><b>CLOCK IN LOCATION</b></td> <td width=60 nowrap><b>CLOCK OUT TIME</b></td><td width=260 nowrap><b>CLOCK OUT LOCATION</b></td><td  width=260 nowrap><b>REPORT LOCATION</b></td><td width=260><b>USERSTAMP</b></td><td width=150 nowrap><b>TIMESTAMP</b></td></tr></thead>';
...
if($x>0){
    while($row=mysqli_fetch_array($sql)){
        ...
        $message=$message. "<tr><td width=260 nowrap>".$adm_loginid."</td><td nowrap>".$final_report."</td><td align='center' width=80>".$checkintime."</td><td  style='word-wrap: break-word;width: 500%;' >".$checkinlocation."</td><td align='center' width=90>".$checkouttime."</td><td style='word-wrap: break-word; width:800px;'>".$checkoutlocation."</td><td style='word-wrap: break-word; width:800px;'>".$report_location."</td><td align='center' width=260>".$adm_userstamp."</td><td align='center' width=150 nowrap>".$adm_timestamp."</td></tr>";
    }

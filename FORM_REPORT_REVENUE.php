...
//            $('.preloader', window.parent.document).hide();
    ...
    var option="common";
    xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option);
...
//                $('.preloader', window.parent.document).hide();
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option+"&login_id="+login_id);
        xmlhttp.send();
    });
// CHANGE EVENT FOR PROJECT LISTBOX
...
//                    $('.preloader', window.parent.document).hide();
            ...
            xmlhttp.open("POST","DB_REPORT_REVENUE.php?option="+choice+"&selectoption="+$('#REV_lb_loginid').val());
            xmlhttp.send(new FormData(formElement));
            //END DATE PICKER FUNCTION
        }
    });
...
//                    $('.preloader', window.parent.document).hide();
            ...
            xmlhttp.open("POST","DB_REPORT_REVENUE.php?option="+choice+"&selectoption="+option);
            xmlhttp.send(new FormData(formElement));
        }
    });
...
//                        if(REV_end_dates!=null && REV_end_dates !=''){
                ...
                xmlhttp.open("GET","DB_REPORT_REVENUE.php?REV_project_name="+REV_project_name+"&option="+choice+"&project_recver="+project_recver,true);
                xmlhttp.send(new FormData(formElement));
                //SET END DATE
...
//                    $('.preloader', window.parent.document).hide();
        ...
        var choice="PROJECTRECVERSION";
        xmlhttp.open("POST","DB_REPORT_REVENUE.php?option="+choice);
        xmlhttp.send(new FormData(formElement));
    });
...
//                $('.preloader', window.parent.document).hide();
        ...
        var choice="login_id";
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?REV_loginids="+REV_loginids+"&option="+choice+"&project_recverss="+project_recverss+"&project_namess="+project_namess,true);
        xmlhttp.send(new FormData(formElement));
        //SET END DATE
...
//                    $('.preloader',window.parent.document).hide();
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option+"&REV_projectname="+REV_projectname+"&project_recver="+project_recver);
        xmlhttp.send();
    });
...
//                    $('.preloader', window.parent.document).hide();
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option+"&REV_loginid="+REV_loginid+"&REV_prjctname="+REV_prjctname+"&REV_withproject="+seacrhby_prjct+"&project_recver="+project_recver);
...
//                    $('.preloader', window.parent.document).hide();
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option+"&REV_loginid="+REV_loginid+"&REV_start_datevalue="+REV_start_datevalue+"&REV_end_datevalue="+REV_end_datevalue+"&REV_prjctname="+REV_prjctname+"&REV_withproject="+seacrhby_prjct+"&rec_ver="+rec_ver);
        xmlhttp.send();
        sorting();
    });
// CLICK EVENT FOR PROJECT SEARCH BUTTON
...
//                    $('.preloader', window.parent.document).hide();
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.php?option="+option+"&REV_projectname="+REV_projectname+"&REV_start_datevalue="+REV_start_datevalue+"&REV_end_datevalue="+REV_end_datevalue+"&REV_project_recver="+REV_project_recversion);
        xmlhttp.send();
    });
    ...
    $(document).on('click','#REV_btn_pdf',function(){
        ...
        var url=document.location.href='COMMON_PDF.php?flag=5&inputValOne='+inputValOne+'&inputValTwo='+inputValTwo+'&title='+title;
    });
    ...
    $(document).on('click','#REV_btn_totalhrs_pdf',function(){
        ...
        inputValFour = inputValFour.split("-").reverse().join("-");
        var url=document.location.href='COMMON_PDF.php?flag=10&inputValOne='+inputValOne+'&inputValTwo='+inputValTwo+'&inputValThree='+inputValThree+'&inputValFour='+inputValFour+'&title='+REV_lbl_dterangetitle;
    });
});

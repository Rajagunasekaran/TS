...
$(document).ready(function(){
    ...
    xmlhttp.onreadystatechange=function() {
        if (xmlhttp.readyState==4 && xmlhttp.status==200) {
            ...
            $('#REV_lb_empproject').html(project_name);
        }
    }
    var option="common";
...
// CLICK EVENT FOR LOGINID SEARCH BUTTON
    ...
    $(document).on('click','#REV_btn_empsrch',function(){
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.do?option="+option+"&REV_loginid="+REV_loginid+"&REV_prjctname="+REV_prjctname+"&REV_withproject="+seacrhby_prjct);
        xmlhttp.send();
        sorting();
    });
// CLICK EVENT FOR LOGINID SEARCH BUTTON
    ...
    $(document).on('click','#REV_btn_search',function(){
            ...
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(loginidvalues)
                {
                    ...
                    else
                    {
                        ...
                        var REV_tble_header='<table id="REV_tble_nonactive_bydaterange" border="1"  cellspacing="0" class="srcresult" style="width:500px";><thead  bgcolor="#6495ed" style="color:white"><tr><th class="uk-date-column" style="width:150px" align="center">PROJECT NAME</th><th >DAYS</th><th >HRS</th><th >MINUTES</th></tr></thead><tbody>'
                        for(var i=0;i<loginidvalues.length;i++){
                            var projectname=loginidvalues[i].projectname;
                            var project_days=loginidvalues[i].project_days;
                            var project_hrs=loginidvalues[i].project_hrs;
                            var project_mints=loginidvalues[i].project_mints;
                            REV_tble_header+='<tr><td style="width:150px">'+projectname+'</td><td align="center">'+project_days+'</td><td align="center">'+project_hrs+'</td><td align="center">'+project_mints+'</td></tr>';
                        }
                    }
        ...
        xmlhttp.open("GET","DB_REPORT_REVENUE.do?option="+option+"&REV_loginid="+REV_loginid+"&REV_start_datevalue="+REV_start_datevalue+"&REV_end_datevalue="+REV_end_datevalue+"&REV_prjctname="+REV_prjctname+"&REV_withproject="+seacrhby_prjct);
        xmlhttp.send();
        sorting();
    });
// CLICK EVENT FOR PROJECT SEARCH BUTTON
...
<div class="wrapper">
    ...
    <form   id="REV_form_revenue" class="content" >
        <table>
            ...
            <tr><td><label id="REV_lbl_dterangetitle" name="REV_lbl_dterangetitle" class="srctitle"></label></td></tr>
            <tr>

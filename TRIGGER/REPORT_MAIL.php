...
if($x>0){
    while($row=mysqli_fetch_array($sql)){
        ...
        $message=$message. "<tr><td width=260 nowrap>".$adm_loginid."</td><td width=260 nowrap>".$rep_worked_project."</td><td nowrap>".$final_report."</td><td align='center' width=80>".$checkintime."</td><td  style='word-wrap: break-word;width: 500%;' >".$checkinlocation."</td><td align='center' width=90>".$checkouttime."</td><td style='word-wrap: break-word; width:800px;'>".$checkoutlocation."</td><td style='word-wrap: break-word; width:800px;'>".$report_location."</td><td align='center' width=260>".$adm_userstamp."</td><td align='center' width=150 nowrap>".$adm_timestamp."</td></tr>";
    }

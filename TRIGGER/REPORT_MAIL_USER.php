...
if($Current_day!='Sunday'){
    if($check_ph==0 && $check_onduty==0){
        ...
        for($i=0;$i<$array_length;$i++){
            ...
            $sub=str_replace("[MAILID_USERNAME]","$empname",$body);
            $message='<body>'.'<br>'.'<h> '.$sub.'</h>'.'<br>'.'<br>'.'<table border=1  width=240 ><thead  bgcolor=#6495ed style=color:white><tr  align=center  height=2px ><td >REPORT DATE</td></tr></thead>';

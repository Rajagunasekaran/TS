...
//    $('#project_access').attr("disabled","disabled");
//    $('#project_search').attr("disabled","disabled");
...
//                        $(document).doValidation({rule:'messagebox',prop:{msgtitle:"EMPLOYEE PROJECT ACCESS",msgcontent:msg,position:{top:100,left:100}}});
                        show_msgbox("EMPLOYEE PROJECT ACCESS",msg,"success",false);
                        EMP_ENTRY_rset()
                        initialload();
                    }
                    else
...
//                        $(document).doValidation({rule:'messagebox',prop:{msgtitle:"EMPLOYEE PROJECT ACCESS",msgcontent:err_msg_array[0],position:{top:100,left:100}}});
                        show_msgbox("EMPLOYEE PROJECT ACCESS",err_msg_array[0],"success",false);
                    }
                }
            }
...
<div class="container">
    ...
    <div class="title text-center"><h4><b>PROJECT ACCESS/SEARCH/UPDATE</b></h4></div>

...
<!--inline edit new-->
    ...
    $(document).on('click','.edit', function (){
        ...
        if(ifcondition=='emailsubject')
        {
            ...
            $('#'+cid).replaceWith("<td class='new' id='"+previous_id+"'><input type='text' id='email_subject' name='email_subject'  class='update' maxlength='50'  value='"+tdvalue+"'></td>");
        }
            ...
            <fieldset>
                <div class ="table-responsive">
                    ...
                    <div class="row-fluid form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea rows="4" cols="50" name="ET_ENTRY_ta_body" id="ET_ENTRY_ta_body" class="tarea form-control maxlength reset" maxlength="50"></textarea>
                        </div>
                    </div>

...
$arrQuery=array( 1=>"SELECT AE.EMPLOYEE_NAME,RC.RC_NAME,UA.UA_REC_VER,DATE_FORMAT(UA.UA_JOIN_DATE,'%d-%m-%Y') AS UA_JOIN_DATE,DATE_FORMAT(UA.UA_END_DATE,'%d-%m-%Y') AS UA_END_DATE,UA.UA_REASON,URC1.URC_DATA,UA.UA_USERSTAMP,DATE_FORMAT(UA.UA_TIMESTAMP , '%d-%m-%Y %h:%m:%s') AS UA_TIMESTAMP FROM USER_LOGIN_DETAILS ULD,ROLE_CREATION RC,USER_ACCESS UA,USER_RIGHTS_CONFIGURATION URC,USER_RIGHTS_CONFIGURATION URC1,VW_TS_ALL_EMPLOYEE_DETAILS AE WHERE UA.UA_EMP_TYPE=URC1.URC_ID AND URC.URC_ID=RC.URC_ID AND ULD.ULD_ID=UA.ULD_ID AND UA.RC_ID=RC.RC_ID AND ULD.ULD_ID=AE.ULD_ID ORDER BY EMPLOYEE_NAME",
    ...
    19=>"SELECT WEEK,WEEKLY_REPORT,USERSTAMP,DATE_FORMAT(CONVERT_TZ(TIMESTAMP,'+00:00','+05:30'), '%d-%m-%Y %T')as TIMESTAMP from $temp_table",
...
//    25=>"SELECT AE.EMPLOYEE_NAME,DATE_FORMAT(ED.EMP_DOB,'%d-%m-%Y') AS EMP_DOB,ED.EMP_DESIGNATION,ED.EMP_MOBILE_NUMBER,ED.EMP_NEXT_KIN_NAME,ED.EMP_RELATIONHOOD,ED.EMP_ALT_MOBILE_NO,ED.EMP_BANK_NAME,ED.EMP_BRANCH_NAME,ED.EMP_ACCOUNT_NAME,ED.EMP_ACCOUNT_NO,ED.EMP_IFSC_CODE,ED.EMP_ACCOUNT_TYPE,ED.EMP_BRANCH_ADDRESS,ED.EMP_AADHAAR_NO,ED.EMP_PASSPORT_NO,ED.EMP_VOTER_ID,ED.EMP_COMMENTS,CPD.CPD_LAPTOP_NUMBER,CPD.CPD_CHARGER_NUMBER,CPD.CPD_LAPTOP_BAG,CPD.CPD_MOUSE,CPD.CPD_DOOR_ACCESS,CPD.CPD_ID_CARD,CPD.CPD_HEADSET,ULD.ULD_USERSTAMP,DATE_FORMAT(CONVERT_TZ(ED.EMP_TIMESTAMP,'+00:00','+05:30'),'%d-%m-%Y %T') AS EMP_TIMESTAMP FROM USER_LOGIN_DETAILS ULD, EMPLOYEE_DETAILS ED LEFT JOIN COMPANY_PROPERTIES_DETAILS CPD ON ED.EMP_ID=CPD.EMP_ID, VW_TS_ALL_EMPLOYEE_DETAILS AE WHERE  ED.ULD_ID = ULD.ULD_ID AND ED.ULD_ID = AE.ULD_ID GROUP BY ED.EMP_ID ORDER BY AE.EMPLOYEE_NAME");
    25=>"SELECT AE.EMPLOYEE_NAME,DATE_FORMAT(ED.EMP_DOB,'%d-%m-%Y') AS EMP_DOB,ED.EMP_DESIGNATION,ED.EMP_MOBILE_NUMBER,ED.EMP_NEXT_KIN_NAME,ED.EMP_RELATIONHOOD,ED.EMP_ALT_MOBILE_NO,ED.EMP_BANK_NAME,ED.EMP_BRANCH_NAME,ED.EMP_ACCOUNT_NAME,ED.EMP_ACCOUNT_NO,ED.EMP_IFSC_CODE,ED.EMP_ACCOUNT_TYPE,ED.EMP_BRANCH_ADDRESS,ED.EMP_AADHAAR_NO,ED.EMP_PASSPORT_NO,ED.EMP_VOTER_ID,ED.EMP_COMMENTS,CP.CP_LAPTOP_NUMBER,CP.CP_CHARGER_NUMBER,CPD.CPD_LAPTOP_BAG,CPD.CPD_MOUSE,CPD.CPD_DOOR_ACCESS,CPD.CPD_ID_CARD,CPD.CPD_HEADSET,ULD.ULD_USERSTAMP,DATE_FORMAT(CONVERT_TZ(ED.EMP_TIMESTAMP,'+00:00','+05:30'),'%d-%m-%Y %T') AS EMP_TIMESTAMP FROM USER_LOGIN_DETAILS ULD, EMPLOYEE_DETAILS ED,COMPANY_PROPERTIES CP LEFT JOIN COMPANY_PROPERTIES_DETAILS CPD ON CPD.CP_ID=CP.CP_ID, VW_TS_ALL_EMPLOYEE_DETAILS AE WHERE ED.EMP_ID=CPD.EMP_ID AND ED.ULD_ID = ULD.ULD_ID AND ED.ULD_ID = AE.ULD_ID GROUP BY ED.EMP_ID ORDER BY AE.EMPLOYEE_NAME");

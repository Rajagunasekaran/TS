...
class ApiMediaFileUploadTest extends BaseTest
{
  public function testMediaFile()
  {
    ...
    $media = new Google_Http_MediaFileUpload(
        ...
        $request,
        'images/png',
        base64_decode('data:images/png;base64,a')
    );
  ...
  public function testGetUploadType()
  {
    ...
    $media = new Google_Http_MediaFileUpload($client, $request, 'images/png', 'a', true);
    $params = array('mediaUpload' => array('value' => $media));
    $this->assertEquals('resumable', $media->getUploadType(null));
        
    // Test data *only* uploads
    $media = new Google_Http_MediaFileUpload($client, $request, 'images/png', 'a', false);
  ...
  public function testProcess()
  {
    ...
    // Test data *only* uploads.
    $request = new Google_Http_Request('http://www.example.com', 'POST');
    $media = new Google_Http_MediaFileUpload($client, $request, 'images/png', $data, false);
    ...
    $media = new Google_Http_MediaFileUpload($client, $request, 'images/png', $data, true);

    ...
    $(document).ready(function(){
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                {
                    var USU_table_header='<table id="USD_SRC_SRC_tble_htmltable" border="1" class="display"  cellspacing="0" width="100%" ><thead  bgcolor="#6495ed" style="color:white"><tr><th>LOGIN ID</th><th>ROLE</th><th>RECORD VERSION</th><th style="width:80px;" class="uk-date-column">JOIN DATE</th><th class="uk-date-column">TERMINATION DATE</th><th style="width:400px">REASON OF TERMINATION</th><th style="width:100px">EMP TYPE</th><th>USERSTAMP</th><th style="width:150px;" class="uk-timestp-column">TIMESTAMP</th></tr></thead><tbody>'
                    ...
                    for(var j=0;j<values_array.length;j++){
                        ...
                        USU_table_header+='<tr><td>'+USD_SRC_loginid+'</td><td>'+USD_SRC_rcid+'</td><td>'+USD_SRC_recordver+'</td><td  style="min-width:80px;">'+USD_SRC_joindate+'</td><td>'+USD_SRC_terminationdate+'</td><td style="min-width:400px;">'+USD_SRC_reasonoftermination+'</td><td style="min-width:100px;">'+USD_SRC_emptype+'</td><td>'+USD_SRC_userstamp+'</td><td  style="min-width:150px;">'+USD_SRC_timestamp+'</td></tr>';
                    }

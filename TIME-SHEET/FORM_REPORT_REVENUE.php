    ...
    $(document).on('click','#REV_btn_prjctsrch',function(){
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(projectvalues)
                {
                    var totalnoof_days= projectvalues[0].noofdays;
                    $('#REV_lbl_totaldays').text("TOTAL NO OF  DAYS: "  +   totalnoof_days   +  "DAYS").show();
                    var REV_table_header='<table id="REV_tble_totaldays" border="1"  cellspacing="0" class="srcresult" ><thead  bgcolor="#6495ed" style="color:white"><tr><th>USERNAME</th><th>TOTAL NUMBER OF DAYS</th></tr></thead><tbody>'
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(loginidvalues)
                {
                    ...
                    $('#REV_lbl_ttlprjct').text("TOTAL NUMBER OF PROJECT WORKED IS: "  +  working_days  +  "PROJECTS").show();
                    $('#REV_lbl_empday').text("TOTAL NO OF  DAYS: "  +   total_days   +  "DAYS").show();
                    var REV_table_header1='<table id="REV_tble_empday_nonactveemp1" border="1"  cellspacing="0" class="srcresult" ><thead  bgcolor="#6495ed" style="color:white"><tr><th class="uk-date-column">PROJECT DATE</th><th>PROJECT NAME</th></tr></thead><tbody>'
                    for(var i=0;i<loginidvalues.length;i++){
                        ...
                        REV_table_header1+='<tr><td>'+projectdate+'</td><td>'+projectname+'</td></tr>';
                    }
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(loginidvalues)
                {
                    ...
                    var working_days= loginidvalues[0].working_day;
                    $('#REV_lbl_ttlprjct').text("TOTAL NUMBER OF PROJECT WORKED IS: "  +  total_no_projects  +  "PROJECTS").show();
//                    $('#REV_lbl_empday').text("TOTAL NO OF  DAYS: "  +   working_days   +  "DAYS").show();
                    var REV_tble_header='<table id="REV_tble_nonactive_bydaterange" border="1"  cellspacing="0" class="srcresult"><thead  bgcolor="#6495ed" style="color:white"><tr><th class="uk-date-column">PROJECT DATE</th><th>PROJECT NAME</th></tr></thead><tbody>'
                    for(var i=0;i<loginidvalues.length;i++){
                        var projectdate=loginidvalues[i].projectdate;
                        var projectname=loginidvalues[i].projectname;
                        REV_tble_header+='<tr><td width="50">'+projectdate+'</td><td width="10">'+projectname+'</td></tr>';
                    }
...
//                    $('#REV_lbl_totaldays').text("TOTAL NUMBER OF DAYS WORKING ON: "  +   working_day   +  "DAYS").show();
                    var REV_table_header='<table id="REV_tble_projctrevenue_bydaterange" border="1"  cellspacing="0" class="srcresult" ><thead  bgcolor="#6495ed" style="color:white"><tr><th>USERNAME</th><th>TOTAL NUMBER OF DAYS</th></tr></thead><tbody>'
                    for(var i=0;i<projectvalues.length;i++){
                        var username=projectvalues[i].username;
                        var noofdays=projectvalues[i].noofdays;
                        REV_table_header+='<tr><td>'+username+'</td><td align="center">'+noofdays+'</td></tr>';

    ...
    <form  name="EMP_ENTRY_form_employeename" id="EMP_ENTRY_form_employeename" class="content" >
        ...
        <table id="EMP_ENTRY_table_employeetbl" hidden>
            ...
            <tr>
                ...
                <td><input type="text" name="EMP_ENTRY_tb_chargerno" id="EMP_ENTRY_tb_chargerno" maxlength='25' class="alphanumeric sizefix"></td>
            </tr><tr><td></td><td>
                    <table id="EMP_ENTRY_table_others" style="width:200px" hidden>
                        <tr>
                            <td>
                                <input type="checkbox" name="EMP_ENTRY_chk" id="EMP_ENTRY_chk_bag" class="">

...
//                alert(values_array)
                if(values_array.length!=0){
                    var USRC_UPD_table_header='<table id="USRC_UPD_tbl_htmltable" border="1"  cellspacing="0" class="srcresult" style="width:1800px";><thead  bgcolor="#6495ed" style="color:white"><tr><th style="width:40px;"></th><th style="width:80px;" class="uk-date-column">DATE</th><th style="max-width:600px; !important;">REPORT</th><th class="uk-timestp-column">TIMESTAMP</th></tr></thead><tbody>'
                    for(var j=0;j<values_array.length;j++){
                        ...
                        if(permission==null)
                        {
                            if(emp_report==null)
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td> REASON:'+emp_reason+'</td><td>'+timestamp+'</td></tr>';
                            }
                            else if(emp_reason==null)
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td style="max-width:600px; !important;"> REPORT:'+emp_report+'</td><td>'+timestamp+'</td></tr>';
                            }
                            else
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td style="max-width:600px; !important;"> REPORT:'+emp_report+' <br><br> REASON:'+emp_reason+'</td><td>'+timestamp+'</td></tr>';
                            }
                        }
                        else
                        {
                            if(emp_report==null)
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td> REASON:'+emp_reason+'<br><br>PERMISSION:'+permission+' hrs</td><td>'+timestamp+'</td></tr>';
                            }
                            else if(emp_reason==null)
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td style="max-width:600px; !important;"> REPORT:'+emp_report+' <br><br>PERMISSION:'+permission+' hrs</td><td>'+timestamp+'</td></tr>';
                            }
                            else
                            {
                                USRC_UPD_table_header+='<tr ><td><input type="radio" name="USRC_UPD_rd_flxtbl" class="USRC_UPD_class_radio" id='+id+'  value='+id+'></td><td>'+emp_date+'</td><td style="max-width:600px; !important;"> REPORT:'+emp_report+' <br><br> REASON:'+emp_reason+' <br><br>PERMISSION:'+permission+' hrs</td><td>'+timestamp+'</td></tr>';
                            }
                        }
                    }
...
//        $('#USRC_UPD_tble_bandwidth').html('');
    ...
    $(document).on('change blur','.update_validate',function(){
        ...
        {
            if(((USRC_UPD_reasontxtarea.trim()!="")&&(USRC_UPD_reportenter!='')&&( USRC_UPD_projectselectlistbx>0) && (USRC_UPD_bndtxt!='') && (USRC_UPD_bndtxt<=1000) &&((USRC_UPD_permission==true) || (USRC_UPD_nopermission==true))))
            {
        ...
        {
            if(((USRC_UPD_reportenter.trim()!="")&&(USRC_UPD_bndtxt!='') && (USRC_UPD_bndtxt<=1000) &&( USRC_UPD_projectselectlistbx>0) && ((USRC_UPD_permission==true) || (USRC_UPD_nopermission==true))))
            {
                if(USRC_UPD_permission==true)
                {
                    if(USRC_UPD_permissionlstbx!='SELECT')

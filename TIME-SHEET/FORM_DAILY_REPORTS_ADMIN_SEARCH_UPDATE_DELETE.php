                ...
                if(allvalues_array!=''){
                    ...
                    for(var j=0;j<allvalues_array.length;j++){
                        ...
                        if(reason==null){
                            ...
                            ASRC_UPD_DEL_tableheader+='<tr ><td>'+login+'</td><td>'+report+'</td><td>'+userstamp+'</td><td nowrap>'+timestamp+'</td></tr>';
                        }
                        else{
                            ASRC_UPD_DEL_tableheader+='<tr ><td>'+login+'</td><td>'+reason+'</td><td>'+userstamp+'</td><td nowrap>'+timestamp+'</td></tr>';
                        }
                    }
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(values_array.length!=0){
                    var ASRC_UPD_DEL_table_header='<table id="ASRC_UPD_DEL_tbl_htmltable" border="1"  cellspacing="0" class="srcresult" style="width:1700px"><thead  bgcolor="#6495ed" style="color:white"><tr><th  style="width:10px"></th><th style="width:60px" class="uk-date-column">DATE</th><th style="max-width:1000px; !important;">REPORT</th><th>USER STAMP</th><th class="uk-timestp-column" style="min-width:100px; !important;">TIME STAMP</th></tr></thead><tbody>'
                    for(var j=0;j<values_array.length;j++){
                        ...
                        if(permission==null)
                        {
                            if(emp_report==null)
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REASON:'+emp_reason+'</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                            else if(emp_reason==null)
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REPORT:'+emp_report+'</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                            else
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REPORT:'+emp_report+' <br><br> REASON:'+emp_reason+'</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                        }
                        else
                        {
                            if(emp_report==null)
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REASON:'+emp_reason+'<br><br>PERMISSION:'+permission+' hrs</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                            else if(emp_reason==null)
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REPORT:'+emp_report+' <br><br>PERMISSION:'+permission+' hrs</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                            else
                            {
                                ASRC_UPD_DEL_table_header+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_flxtbl" class="ASRC_UPD_DEL_class_radio" id='+id+'  value='+id+' ></td><td>'+emp_date+'</td><td style="max-width:1000px; !important;"> REPORT:'+emp_report+' <br><br> REASON:'+emp_reason+' <br><br>PERMISSION:'+permission+' hrs</td><td style="max-width:250px;">'+userstamp+'</td><td style="min-width:90px;" nowrap>'+timestamp+'</td></tr>';
                            }
                        }
                    }
...
//            $("#ASRC_UPD_DEL_lbl_flag").show();
    ...
    $(document).on('change blur','.update_validate',function(){
        ...
        {
            if(((ASRC_UPD_DEL_reasontxtarea.trim()!="")&&(ASRC_UPD_DEL_reportenter!='')&&( ASRC_UPD_DEL_projectselectlistbx>0) && (ASRC_UPD_DEL_bndtxt!='') && (ASRC_UPD_DEL_bndtxt<=1000) && ((ASRC_UPD_DEL_permission==true) || (ASRC_UPD_DEL_nopermission==true))))
            {
        ...
        {
            if(((ASRC_UPD_DEL_reportenter.trim()!="")&&(ASRC_UPD_DEL_bndtxt!='') && (ASRC_UPD_DEL_bndtxt<=1000) && (ASRC_UPD_DEL_bndtxt<=1000)&&( ASRC_UPD_DEL_projectselectlistbx>0) && ((ASRC_UPD_DEL_permission==true) || (ASRC_UPD_DEL_nopermission==true))))
            {
                if(ASRC_UPD_DEL_permission==true)
                {
                    if(ASRC_UPD_DEL_permissionlstbx!='SELECT')
    ...
    $(document).on('click','#ASRC_UPD_DEL_btn_submit',function(){
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(msg_alert==1)
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"ADMIN SEARCH AND UPDATE",msgcontent:err_msg[1],confirmation:true}});
                    ASRC_UPD_DEL_clear()
                    flextablerange()
                    $("#ASRC_UPD_DEL_btn_del").hide();
                    $("#ASRC_UPD_DEL_btn_srch").hide();
                ...
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"ADMIN SEARCH AND UPDATE",msgcontent:err_msg[7],confirmation:true}});
                    ASRC_UPD_DEL_clear()
                    flextablerange()
                    $("#ASRC_UPD_DEL_btn_del").hide();
                    $("#ASRC_UPD_DEL_btn_srch").hide();
                ...
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"ADMIN SEARCH AND UPDATE",msgcontent:msg_alert,confirmation:true}});
                    ASRC_UPD_DEL_clear()
                    flextablerange()
                    $("#ASRC_UPD_DEL_btn_del").hide();
                    $("#ASRC_UPD_DEL_btn_srch").hide();
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(allvalues_array.length!=0){
                    var ASRC_UPD_DEL_tbleheader='<table id="ASRC_UPD_DEL_tbl_ondutyhtmltable" border="1"  cellspacing="0" class="srcresult" style="width:1180px" ><thead  bgcolor="#6495ed" style="color:white"><tr><th style="width:30px;"></th><th style="width:80px;" class="uk-date-column">DATE</th><th>DESCRIPTION</th><th>USERSTAMP</th><th class="uk-timestp-column">TIMESTAMP</th></tr></thead><tbody>';
                    for(var j=0;j<allvalues_array.length;j++){
                        ...
                        ASRC_UPD_DEL_tbleheader+='<tr ><td><input type="radio" name="ASRC_UPD_DEL_rd_tbl" class="ASRC_UPD_DEL_class_radio odclass" id='+id+'  value='+id+' ></td><td>'+date+'</td><td style="max-width:400px">'+description+'</td><td style="max-width:155px">'+userstamp+'</td><td style="max-width:100px">'+timestamp+'</td></tr>';
                    }

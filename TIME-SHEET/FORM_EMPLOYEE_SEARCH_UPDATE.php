...
<div class="wrapper">
    ...
    <form  name="EMPSRC_UPD_DEL_form_employeename" id="EMPSRC_UPD_DEL_form_employeename" class="content">
        ...
        <div id ="EMPSRC_UPD_DEL_flexdata_result" style="height:3000px;width:2220px;overflow:auto;">
        ...
        <table id ="EMPSRC_UPD_DEL_table_updateform" hidden >
            ...
            <tr>
                ...
                <td><input type="text" name="EMPSRC_UPD_DEL_tb_chargerno" id="EMP_ENTRY_tb_chargerno" maxlength='30' class="alphanumeric sizefix"></td>
            </tr>
            <tr><td></td><td>

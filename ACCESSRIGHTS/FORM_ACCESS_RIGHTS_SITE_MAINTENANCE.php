...
//            $('.preloader', window.parent.document).hide();
    ...
    xmlhttp.open("GET","ACCESSRIGHTS/DB_ACCESS_RIGHTS_SITE_MAINTENANCE.do?option="+option);
    xmlhttp.send();
...
//                        $('.preloader', window.parent.document).hide();
        ...
        xmlhttp.open("POST","ACCESSRIGHTS/DB_ACCESS_RIGHTS_SITE_MAINTENANCE.do?option="+choice,true);

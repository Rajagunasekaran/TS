...
//*********************************************************************************************************//-->
<?php
//include '../TSLIB_HEADER.php';//HEADER FILE CALLED IN OUTSIDE
...
<div id="ARE_tble_singledayentry" hidden>
    ...
    <div class="row-fluid form-group">
        ...
        <div class="col-sm-8">
            <select name="ARE_lb_loginid" id="ARE_lb_loginid"class="form-control"style="width: 300px;">
            </select><br>
...
<div class="row-fluid form-group">
    ...
    <div class="col-sm-4">
        <select name="ARE_lb_ampm" id="ARE_lb_ampm" >
            <option>SELECT</option>
...
<div id="search" hidden>
    <div class="row-fluid form-group">
        ...
        <div class="col-sm-2">
            ...
            <select id="options" name="option"class="form-control" style="width: 350px;">
                <option>SELECT</option>

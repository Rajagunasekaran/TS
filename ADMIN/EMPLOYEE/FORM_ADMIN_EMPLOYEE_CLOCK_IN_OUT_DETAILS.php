...
//                        $('.preloader', window.parent.document).hide();
                ...
                if(CLK_start_dates!='' &&CLK_start_dates !=null){
                    $('.date').datepicker("option","minDate", new Date(CLK_start_dates));
                    $('.date').datepicker("option","maxDate", new Date(CLK_end_dates));}
...
<div class="container">
    ...
    <form id="REP_chk_form_details" class="content" role="form">
        ...
        <div class="row-fluid form-group">
            ...
            <div class="col-sm-4">
                <input type="text" name="REP_tb_date" id="REP_tb_date" class="enable clear REP_date_picker datemandtry">
            </div></div>

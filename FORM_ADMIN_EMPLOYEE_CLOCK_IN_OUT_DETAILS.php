...
//                $('.preloader', window.parent.document).hide();
        ...
        $(document).on('change','#REP_chk_rd_allactveemp',function(){
            ...
            $('#REP_tble_absent_count').hide();
            $('section').html('');
            $('<div><label class="col-sm-3" name="REP_lbl_date" id="REP_lbl_date" >DATE<em>*</em></label></div><div class="col-sm-4"><input type="text" name="REP_tb_date" id="REP_tb_date" class="enable clear REP_date_picker datemandtry" style="" ></div>').appendTo('#REP_tble_date')
            $('<div class="col-sm-12"><input type="button" class="btn " name="REP_btn_date" id="REP_btn_date"  value="SEARCH" disabled></div>').appendTo('#REP_tble_searchbutton')
        ...
        <div class="panel-body">
            <fieldset>
                ...
                <div id="clockinout" hidden>
                    <div class="row-fluid form-group">
                        <label class="col-sm-3" name="REP_chk_lbl_srchby" id="REP_chk_lbl_srchby">SEARCH BY<em>*</em></label>
                        <div class="col-sm-6">
...
<div class="row-fluid form-group">
    <label class="col-sm-3" name="REP_lbl_loginid" id="REP_lbl_loginid"  hidden>EMPLOYEE NAME<em>*</em></label>
    <div class="col-sm-6">
...
<div class="row-fluid form-group">
    <label class="col-sm-3" name="REP_lbl_strtdtebyrange" id="REP_lbl_strtdtebyrange" hidden>START DATE<em>*</em></label>
    <div class="col-sm-4">
...
<div class="row-fluid form-group">
    <label class="col-sm-3" name="REP_lbl_enddte" id="REP_lbl_enddte" hidden>END DATE<em>*</em></label>
    <div class="col-sm-4">
...
<div id="clockmissed" hidden>
    <div class="row-fluid form-group">
        ...
        <div class="col-sm-4">
            <select id="CLK_lb_reportconfig" name="CLK_lb_reportconfig" class="form-control"  hidden>
            </select>
        </div>
    </div>

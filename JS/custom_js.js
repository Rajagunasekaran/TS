...
//document.body.style.background = "url(data:images/svg+xml;base64,"+encoded+")";
//        canvas = new fabric.Canvas('canvas');
                fabric.Image.fromURL('data:images/svg+xml;base64,' + encoded,
                        function (oImg) {
                            oImg.set({
                                width: 30,
                                height: 30,

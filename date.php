...
$(document).ready(function(){
    ...
    $( "#REP_BND_db_selectmnth").datepicker({
        ...
        beforeShow : function(input, inst){
            ...
            var other = this.id == "REP_BND_db_selectmnth" ? "#REP_BND_db_selectmnth" : "#REP_BND_db_selectmnth";
            var option = this.id == "REP_BND_db_selectmnth" ? "maxDate" : "minDate";
            if ((selectedDate = $(other).val()).length > 0) {
                year = selectedDate.substring(selectedDate.length-4, selectedDate.length);
                month = jQuery.inArray(selectedDate.substring(0, selectedDate.length-5), $(this).datepicker('option', 'monthNames'));
                $(this).datepicker( "option", option, new Date(year, month, 1));
    ...
    $(document).on('change','#REP_BND_lb_reportconfig',function(){
        ...
        else if(option=='11')
        {
            ...
            xmlhttp.onreadystatechange=function() {
                ...
                alert($("#REP_BND_db_selectmnth").val()+'date')
                dpvalidation();
...
//                        $('#REP_BND_db_selectmnth').datepicker('setDate', new Date(year, month, 1));
//                    },
//                    beforeShow: function(input, inst) {
//                        if ((datestr = $(this).val()).length > 0) {
//                            year = datestr.substring(datestr.length - 4, datestr.length);
//                            month = jQuery.inArray(datestr.substring(0, datestr.length - 5), $(this).datepicker('option', 'monthNames'));
//                            $(this).datepicker('option', 'defaultDate', new Date(year, month, 1));
//                            alert(year+'11'+month+'22'+new Date(year, month, 1))
...
//                    $(".date-pickers").datepicker("option","maxDate", new Date(REP_BND_end_dates));}
                ...
                function dpvalidation(){
                   ...
                   else if(($('#REP_BND_db_selectmnth').val()!='undefined')&&($('#REP_BND_db_selectmnth').val()!=''))
                    {
                        alert('not null');
...
//                    }
    ...
    $(document).on('change','#REP_BND_lb_loginid',function(){
        ...
        else
        {
            ...
            var REP_BND_start_dates
            var REP_BND_end_dates
            var xmlhttp=new XMLHttpRequest();
            xmlhttp.onreadystatechange=function() {
                if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                    $('.preloader', window.parent.document).hide();
                    alert(xmlhttp.responseText);
                    date_val=JSON.parse(xmlhttp.responseText);
                    REP_BND_start_dates=date_val[0];
                    REP_BND_end_dates=date_val[1];
                    alert(REP_BND_start_dates)
                    alert(REP_BND_end_dates)
                }
...
<div class="wrapper">
    ...
    <form   id="REP_BND_form_bandwidth" class="content" >
        ...
        <div class="row-fluid form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="REP_BND_db_selectmnth" id="REP_BND_db_selectmnth" class="REP_BND_db_selectmnth date-picker datemandtry validation" style="width:110px;" hidden>
            </div></div>
        ...
        <div class="row-fluid form-group">
            <label name="REP_BND_lbl_selectmnth"  class="col-sm-2" id="REP_BND_lbl_selectmnth" hidden>SELECT MONTH<em>*</em></label>
            <div class="col-sm-8">
                <input type="text" name="REP_BND_db_selectmnth" id="REP_BND_db_selectmnth" class="date-pickers datemandtry validation" style="width:110px;" hidden>
            </div></div>
        <div>
        ...
        <label id="REP_BND_nodata_pdflextble" name="REP_BND_nodata_pdflextble" class="errormsg"></label>
        <div id ="REP_BND_div_monthyr" class="table-responsive" style="max-width:500px" hidden>
            <sections>
            </sections>
        </div>
        <div id="REP_BND_tble_prjctrevactnonact" hidden>
            <div class="row-fluid form-group">
                <label name="REP_BND_lbl_actveemp" class="col-sm-12" id="REP_BND_lbl_actveemp"  hidden>
                    <input type="radio" name="REP_BND_rd_actveemp" id="REP_BND_rd_actveemp" value="EMPLOYEE" hidden >ACTIVE EMPLOYEE</label>

            </div>
            <div class="row-fluid form-group">
                <label name="REP_BND_lbl_nonactveemp" class="col-sm-12" id="REP_BND_lbl_nonactveemp"  hidden>
        ...
        <label id="REP_BND_nodata_lgnid" name="REP_BND_nodata_lgnid" class="errormsg"></label>
        <div class="row-fluid form-group">
        ...
        <div class="row-fluid form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="REP_BND_db_selectmnths" id="REP_BND_db_selectmnths" class="date-pickers datemandtry valid" style="" hidden>
            </div></div>
        <div>
        ...
        <div id ="REP_BND_div_actvenon_dterange"class="table-responsive" style="max-width:400px" hidden>
            <section>
            </section>
        </div>

...
<div class="wrapper">
    ...
    <div class="title" id="fhead" ><div style="padding-left:500px; text-align:left;"><p><h3>EMPLOYEE PROJECT ACCESS SEARCH/UPDATE</h3><p></div></div>
    <form  name="EMPSRC_UPD_form_employeename" id="EMPSRC_UPD_form_employeename" class="content" >
        <table>
            <tr>
                <td style="width:160px"><label name="EMPSRC_UPD_lbl_loginid" id="EMPSRC_UPD_lbl_loginid" hidden>EMPLOYEE NAME<em>*</em></label></td>
